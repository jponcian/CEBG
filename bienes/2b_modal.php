...
<?php
//--------------------
$consult = "SELECT bn_dependencias.division, trim(a_areas.area) as area, a_areas.* FROM a_areas, bn_bienes, bn_dependencias WHERE bn_dependencias.id = a_areas.id_direccion 	AND a_areas.id = bn_bienes.id_area $condicion GROUP BY id_area ORDER BY area;";// WHERE id_direccion='$desde'
