...
$i=0;
//----------------------
$consulta_xxx = "SELECT COUNT(bn_bienes.id_bien) as cant, division, SUM(bn_bienes.valor) as total FROM bn_bienes, bn_dependencias WHERE bn_bienes.id_dependencia = bn_dependencias.id GROUP BY bn_dependencias.id"; //echo $consulta_xxx;
