...
//	$this->Image('../../images/escudo.jpg',165,12,28);
	...
	$this->Cell(0,5,'ESTADO DE CUENTA',0,1,'C'); 
	...
	$this->Cell($_SESSION['b']=50,7,'Concepto',1,0,'C',1);
	$this->Cell($_SESSION['c']=15,7,'Orden',1,0,'C',1);
	$this->Cell($_SESSION['d']=25,7,'Ch/Tr',1,0,'C',1);
	$this->Cell($_SESSION['e']=27,7,'Debe',1,0,'C',1);
	$this->Cell($_SESSION['f']=27,7,'Haber',1,0,'C',1);
...
while ($registro = $tabla->fetch_object())
	...
	if ($registro->nombre_orden<>'')	{	$descripcion=($registro->nombre_orden);	}
		else	{	$descripcion=($registro->concepto);	}
	//----------
	...
	$pdf->SetFont('Times','',8);
	$pdf->Cell($_SESSION['b'],5.5,($descripcion),1,0,'L',1);
	$pdf->SetFont('Times','',9);
	$pdf->Cell($_SESSION['c'],5.5,rellena_cero($registro->numero_orden,6),1,0,'R',1);//$registro->referencia
	$pdf->Cell($_SESSION['d'],5.5,($registro->ref),1,0,'R',1);
...
$pdf->Cell($_SESSION['e'],6,formato_moneda($debe),1,0,'R',1);
$pdf->Cell($_SESSION['f'],6,formato_moneda($haber),1,0,'R',1);
$pdf->Cell(0,6,'',1,0,'R',1);
