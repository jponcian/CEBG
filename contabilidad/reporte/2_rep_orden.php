...
//		{ $total=$registro->descripcion; }	
//	elseif ($registro->estatus==99)	
//		{ $total='A.N.U.L.A.D.A'; } 
//		else { $total=formato_moneda($registro->total); }
	//----------
	...
	$pdf->Cell($e,5.5,formato_moneda($registro->total),1,0,'R',1);//$total
...
$pdf->Cell($f,7,formato_moneda($asignaciones),1,0,'R',1);
