...
<form id="form1" name="form1" method="post" onsubmit="return evitar();" >
        <diw class="row ml-3">
           ...
           <!-- <div class="form-check ml-3">
			...
			<div class="form-check ml-3">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="optradio" value="6" checked="checked" onclick="ver();buscar();" >
                   Dia Actual
                </label>
            </div>
			<div class="form-check ml-3">
...
function rep()
	...
	if (document.form1.optradio.value>0)
		{
			//{
			window.open("contabilidad/reporte/2_rep_orden.php","_blank");
			//}
		}
	}
//---------------------------
...
function enviar(id){
	...
	$('#modal_lg').load('contabilidad/3b_modal.php?id='+id);
}
//---------------------
...
function buscar(){
	...
	$('#div1').load('contabilidad/3a_tabla.php?valor='+cambia(document.form1.obuscar.value)+'&tipo='+document.form1.optradio.value+'&fecha1='+document.form1.OFECHA.value+'&fecha2='+document.form1.OFECHA2.value);
}
//------------------
buscar();
</script>