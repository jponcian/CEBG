...
<form id="form888" name="form888" method="post">
	...
	<div class="modal-header bg-fondo text-center">
		<h4 align="center" style="background-color:#0275d8; color:#FFFFFF" class="modal-title w-100 font-weight-bold py-2">Orden de Compra y/o Servicio
		...
		<div class="row">
			<div class="form-group col-sm-12">
				<div class="input-group">
					<div class="input-group-text" align="center"><i class="fas fa-list-ol mr-2"></i>N° Orden de Compra y/o Servicio</div>
					<select class="form-control " id="txt_nuevo" name="txt_nuevo">
						<option value="0">Correlativo</option>
						<?php
						$consultx = "SELECT id, numero, fecha FROM orden_solicitudes WHERE orden_solicitudes.estatus=99 AND (descripcion='A.P.A.R.T.A.D.A' or descripcion='R.E.V.E.R.S.A.D.A') ORDER BY numero DESC;";
