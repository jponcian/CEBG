...
<form id="form1" name="form1" method="post" onsubmit="return evitar();">
	<div align="center" class="TituloP">Eliminar Orden de Compra y/o Servicio</div>
	<br>
	<diw class="row ml-3">
...
<script language="JavaScript">
	...
	function anular(id, id_solicitud, estatus) {
		Swal.fire({
			title: "¿Estas seguro de continuar con el Borrado?",
			icon: "warning",
	...
	function buscar() {
		if ((document.form1.obuscar.value == "  " || document.form1.obuscar.value == " " || document.form1.obuscar.value == "") && document.form1.optradio.value != 4) {} else {
			...
			$('#div1').load('compras/7a_tabla.php?valor=' + cambia(document.form1.obuscar.value) + '&tipo=' + document.form1.optradio.value);
		}
	}
	//---------------------
