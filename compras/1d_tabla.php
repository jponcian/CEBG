...
$consultx = "SELECT id, categoria, partida, cantidad, descripcion, precio_uni, total, exento, porcentaje_iva, medida FROM presupuesto WHERE id_contribuyente=$id_cont AND estatus=0 ORDER BY id;"; 
//echo $consultx;
$tablx = $_SESSION['conexionsql']->query($consultx);

while ($registro = $tablx->fetch_object())
	{
	if (substr($registro->partida,0,7)=='4031801') { $iva = $registro->porcentaje_iva;	}
	$i++;
...
<td ><div align="left" ><?php echo ($registro->medida); ?></div></td>
...
<td ><div align="center" ><a data-toggle="tooltip" title="Eliminar"><button type="button" class="btn btn-outline-danger btn-sm" onclick="eliminar('<?php echo encriptar($registro->id); ?>','<?php echo encriptar($id_cont); ?>');"><i class="fas fa-trash-alt"></i></button></a></div></td>
 ...
 ?>
<tr >
<td bgcolor="#CCCCCC"  colspan="8" ><div align="right" ><strong>Total de la Orden => <?php echo formato_moneda($total); ?></strong></div></td>
</tr>
</table>
