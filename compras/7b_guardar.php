...
$consultax = "DELETE FROM orden WHERE numero='$numero' AND fecha='$fecha' AND id_contribuyente='$id_contribuyente' AND tipo_orden='$tipo_orden';"; 
$tablax = $_SESSION['conexionsql']->query($consultax);
//---------
if ($estatus>0)
	{
	$consulta_x = "DELETE FROM orden_solicitudes WHERE id = ".$id_solicitud.";"; 
