...
<form id="form999" name="form999" method="post">
	...
	<div class="modal-header bg-fondo text-center">
		<h4 align="center" style="background-color:#0275d8; color:#FFFFFF" class="modal-title w-100 font-weight-bold py-2">Comprometer Orden de Compra
		...
		<div class="row">
			...
			<div class="form-group col-sm-6">
				<div class="input-group">
					<input class="form-control" type="text" style="text-align:center" maxlength="20" value="<?php echo compromiso_sig(1); ?>" readonly />
				</div>
			</div>
...
<script language="JavaScript">
	...
	function apartar_num() {
		Swal.fire({
			title: "¿Estas seguro de comprometer la Orden de Compra?",
			icon: "question",
			...
			if (result.isConfirmed) {
				...
				$.ajax({
					type: 'POST',
					url: 'compras/19a_guardar.php?tipo=1',
					dataType: "json",
					data: parametros,
