...
<form id="form1" name="form1" method="post" onsubmit="return evitar();" >
 <div align="center" class="TituloP">Anulaci&oacute;n Comprobante de Pago</div>
		<br >
		<diw class="row ml-3">
...
function anular(id_pago, id_solicitud)
	...
	alertify.confirm("Estas seguro de continuar con la Anulacion?", function()
		...
		$.ajax({  
		type : 'POST',
		url  : 'administracion/10b_guardar.php',
		dataType:"json",
		data:  parametros, 
...
if((document.form1.obuscar.value=="  " || document.form1.obuscar.value==" " || document.form1.obuscar.value=="") && document.form1.optradio.value!=4){}
	...
	$('#div1').load('administracion/10a_tabla.php?valor='+cambia(document.form1.obuscar.value)+'&tipo='+document.form1.optradio.value);
	}
}
</script>