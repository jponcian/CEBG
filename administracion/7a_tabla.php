...
<td ><div align="center" ><a data-toggle="tooltip" title="Anular Orden de Pago"><button type="button" class="btn btn-outline-danger waves-effect" onclick="anular('<?php echo encriptar($registro->id); ?>','<?php echo encriptar($registro->id_solicitud); ?>');" ><i class="fas fa-window-close prefix grey-text mr-1"></i></button></a></div></td>
