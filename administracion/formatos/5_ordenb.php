...
class PDF extends FPDF
{
	...
	{    
		...
		$consultx = "SELECT	orden.usuario, orden.id, orden.id_contribuyente, orden.rif, orden.fecha, orden.anno, orden.concepto, orden.numero, contribuyente.nombre FROM contribuyente, orden  WHERE tipo_orden='F' AND id_solicitud = $id AND orden.id_contribuyente = contribuyente.id LIMIT 1;"; 
//		echo $consultx;
...
//-----------------
$consulta = "SELECT orden.categoria, orden.partida, orden.cantidad, orden.descripcion, orden.precio_uni, orden.total FROM orden WHERE tipo_orden='F' AND orden.id_solicitud = $id  ORDER BY id;";
//echo $consulta;
