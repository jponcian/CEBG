...
<tr>
<td class="TituloTablaP" height="41" colspan="10" align="center">Solicitud de Pago (Compras, Servicios, Manual y Financiera)</td>
</tr>
<tr>
...
$consultx = "SELECT contribuyente.nombre, orden_solicitudes.tipo_orden, orden_solicitudes.id_contribuyente, contribuyente.rif, orden_solicitudes.fecha_sol, orden_solicitudes.descripcion, orden_solicitudes.numero, orden_solicitudes.total, orden_solicitudes.id FROM contribuyente , orden_solicitudes WHERE orden_solicitudes.tipo_orden<>5 and orden_solicitudes.id_contribuyente = contribuyente.id AND orden_solicitudes.estatus = 5 ORDER BY orden_solicitudes.fecha_sol DESC;"; 
//echo $consultx;
...
while ($registro = $tablx->fetch_object())
	{
	$i++;
	if ($registro->tipo_orden=='CC' or $registro->tipo_orden=='CD' or $registro->tipo_orden=='CP') {$tipo='COMPRA';}
	if ($registro->tipo_orden=='M') {$tipo='MANUAL';}
	if ($registro->tipo_orden=='F') {$tipo='FINANCIERA';}
	?>
<tr >
<td><div align="center" ><?php echo ($i); ?></div></td>
<td ><div align="left" ><?php echo ($registro->rif); ?></div></td>
<td ><div align="left" ><strong><?php echo ($registro->nombre); ?></strong></div></td>
<td ><div align="left" ><?php echo voltea_fecha($registro->fecha_sol); ?></div></td>
<td ><div align="left" ><strong><?php echo $tipo.' '.rellena_cero($registro->numero,8); ?></strong></div></td>
