...
<form id="form1" name="form1" method="post" onsubmit="return evitar();" >
 <div align="center" class="TituloP">Modificar Concepto Orden de Pago</div>
		<br >
		<diw class="row ml-3">
...
function guardar(boton)
	...
	function()
		...
		$.ajax({  
			type : 'POST',
			url  : 'administracion/16j_guardar.php',
			dataType:"json",
			data:  parametros, 
...
function modificar(id, tipo, estatus)
	...
	$('#modal_lg').load('administracion/16b_modal.php?id='+id+'&tipo='+tipo+'&estatus='+estatus);
	}
//---------------------
...
if (((document.form1.optradio.value==1 || document.form1.optradio.value==2 || document.form1.optradio.value==5) && document.form1.obuscar.value!='') || (document.form1.optradio.value==3 && document.form1.OFECHA.value!='' && document.form1.OFECHA2.value!='') || (document.form1.optradio.value==4))
	...
	$('#div1').load('administracion/16a_tabla.php?valor='+cambia(document.form1.obuscar.value)+'&tipo='+document.form1.optradio.value+'&fecha1='+document.form1.OFECHA.value+'&fecha2='+document.form1.OFECHA2.value);
	}
}
</script>