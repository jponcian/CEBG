...
<tr>
<td class="TituloTablaP" height="41" colspan="9" align="center">Orden de Pago en Sistema</td>
</tr>
<tr>
...
$consultx = "SELECT ordenes_pago.descripcion, ordenes_pago.id, ordenes_pago.tipo_solicitud, ordenes_pago.numero, ordenes_pago.fecha, ordenes_pago.asignaciones, ordenes_pago.descuentos, ordenes_pago.total, ordenes_pago.estatus, contribuyente.rif, contribuyente.nombre FROM ordenes_pago , contribuyente WHERE ordenes_pago.estatus<>99 AND (ordenes_pago.estatus>=0) AND contribuyente.id = ordenes_pago.id_contribuyente $filtrar;";
//echo $consultx;
...
<td ><div align="center" ><a data-toggle="tooltip" title="Modificar Orden"><button type="button" data-toggle="modal" data-target="#modal_largo" class="btn btn-info waves-effect" onclick="modificar('<?php echo ($registro->id); ?>','<?php echo ($registro->tipo_solicitud); ?>','<?php echo ($registro->estatus); ?>');" >Modificar</button></a></div></td>
