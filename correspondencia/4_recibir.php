...
<form id="form1" name="form1" method="post" onSubmit="return evitar();" >
        <div align="center" class="TituloP">Correspondencia Externa</div>
		<br >
<div  class="text-right mb-3"><a href="" class="btn btn-outline-primary btn-rounded btn-sm font-weight-bold" onclick="agregar(0);" data-toggle="modal" data-target="#modal_largo" data-backdrop="static" data-keyboard="false"><i class="fas fa-plus-circle" ></i> Recibir</a></div>
		<diw class="row ml-3">
...
<!--			<div class="form-check ml-3">
			...
			<div class="form-check ml-3">
                <label class="form-check-label">
                   ...
                   Aprobadas y Enviados
                </label>
            </div>-->
			<div class="form-check ml-3">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="optradio" value="6" onclick="ver();buscar()" checked="checked" >
                   Por Recibir
                </label>
            </div>
			<div class="form-check ml-3">
...
//	{
//	alertify.confirm("Estas seguro de Enviar la Correspondencia?",  
//	function()
//		{
//		var parametros = "id=" + id; 
//		$.ajax({  
//			type : 'POST',
//			url  : 'correspondencia/2k_guardar.php?',
//			dataType:"json",
//			data:  parametros, 
//			success:function(data) {  	
//				if (data.tipo=="info")
...
if((document.form1.obuscar.value=="  " || document.form1.obuscar.value==" " || document.form1.obuscar.value=="") && document.form1.optradio.value<2){}
		...
		$('#div1').load('correspondencia/4a_tabla.php?valor='+cambia(document.form1.obuscar.value)+'&tipo='+document.form1.optradio.value+'&fecha1='+document.form1.OFECHA.value+'&fecha2='+document.form1.OFECHA2.value);
		}
}
//-----------------------
function aprobar_memo(id)
	{
	$('#modal_lg').html('<div align="center"><div class="spinner-border" role="status"></div><br><strong>Un momento, por favor...</strong></div>');
	$('#modal_lg').load('correspondencia/2c_modal.php?id='+id);
	}
//-----------------------
function agregar(id)
	{
