...
<td ><div align="center" ><?php if ($registro->estatus==999) { ?><button onclick="generar_memo('<?php echo encriptar($registro->id); ?>','<?php echo encriptar($registro->direccion_origen); ?>','<?php echo encriptar($registro->anno); ?>','<?php echo encriptar($registro->firma_contralor); ?>');" type="button" id="boton<?php echo ($registro->id); ?>" class="btn btn-outline-success waves-effect"><i class="fa-regular fa-circle-check prefix grey-text mr-1"></i> Aprobar</button><?php } ?>
