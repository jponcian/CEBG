...
<option value="1">Visita Diaria</option>
...
function reportes2()
	 ...
	 if (document.form1.txt_tipo.value==1 && document.form1.OFECHA.value!='' && document.form1.OFECHA2.value!='')
		...
		window.open("seguridad/reporte/visitas_detalle.php?tipo="+document.form1.txt_tipo.value+"&fecha1="+document.form1.OFECHA.value+"&fecha2="+document.form1.OFECHA2.value,"_blank");
		}
	}
</script>