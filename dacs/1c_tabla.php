...
<td class="TituloTablaP" height="41" colspan="10" align="center">TICKETS ABIERTOS (ATENCIÓN PERSONAL)</td>
</tr>
--><thead>
<tr>
...
FROM
	...
	rac_visita 
WHERE
	tipo=1 AND dacs_atencion.cedula = rac_visita.cedula AND fecha='".date('Y/m/d')."' $filtro ORDER BY estatus, fecha DESC, comienzo DESC;";
//echo $consultx;
