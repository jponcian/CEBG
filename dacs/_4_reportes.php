...
function reportes2()
	 ...
	 if (document.form1.txt_tipo.value==1 && document.form1.OFECHA.value!='') // && document.form1.OFECHA2.value!=''
	 	{
		window.open("seguridad/reporte/asistencia.php?tipo="+document.form1.txt_tipo.value+"&fecha1="+document.form1.OFECHA.value,"_blank");//+"&fecha2="+document.form1.OFECHA2.value
		}
	//----------
	if (document.form1.txt_tipo.value==8)
	 	{
		window.open("contabilidad/reporte/3_suatec.php?fecha1="+document.form1.OFECHA.value,"_blank");//+"&fecha2="+document.form1.OFECHA2.value
		}
