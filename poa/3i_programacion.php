...
<div class="modal-header bg-fondo text-center">
	<button type="button" class="btn btn-outline-info btn-sm" onclick="modal_meta('<?php echo ($id_proyecto); ?>','<?php echo ($unidad); ?>');">Volver</button><h4 align="center" style="background-color:#0275d8; color:#FFFFFF" class="modal-title w-100 font-weight-bold py-2">Balance de Gestion
...
<td width="5%" valign="middle" <?php 
	...
	<label for="c<?php echo ($registro_x->nombre); ?>" class="lbl_switch"></label>
	</td>
<td width="25%" > 
...
<td > 
	...
	<div class="input-group">
		...
		<input disabled type="text" style="text-align:center" class="form-control " name="txt_fecha<?php echo ($registro_x->nombre); ?>" id="txt_fecha<?php echo ($registro_x->nombre); ?>" placeholder="Fecha de la Gestión" minlength="1" maxlength="10" onchange="validar_campo('txt_detalle<?php echo ($registro_x->nombre); ?>');" value="<?php  echo date('d/m/Y');?>" required></div>
	</td>
...
while ($registro_x = $tablx->fetch_object())
//-------------
	{ echo '$("#txt_fecha'.($registro_x->nombre).'").datepicker();'; } 
?>		
