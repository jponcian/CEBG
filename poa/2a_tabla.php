...
<th  bgcolor="#CCCCCC" align="center"><strong>Tipo</strong></th>
<th  bgcolor="#CCCCCC" align="center"><strong>Denominacion</strong></th>
<th  bgcolor="#CCCCCC" align="center"><strong>Objetivo</strong></th>
<th  bgcolor="#CCCCCC" align="center"><strong>Supuesto</strong></th>
...
$consultx = "SELECT * FROM poa_proyecto WHERE anno = '$anno' ORDER BY numero";//$filtrar.$_GET['valor'].";"; //echo $consultx;
