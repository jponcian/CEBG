...
<form id="form1" name="form1" method="post" onsubmit="return evitar();" >
        <div align="center" class="TituloP">Autorizar Solicitudes</div>
		<br >
...
function listar_bienes(id){
	...
	$('#div3').load('almacen/5d_tabla.php?id='+id);
}
//------------------
function generar_solicitud(id)
	...
	Swal.fire({
		...
		confirmButtonText: '<i class="fa fa-thumbs-up"></i>, Procesar!',
...
function combo2()
{
	$.ajax({
        type: "POST",
        url: 'almacen/5c_combo2.php?origen='+document.form999.txt_origen.value,
...
function buscar2(){
	...
	$('#div1').load('almacen/5a_tabla.php?valor='+cambia(document.form1.obuscar.value)+'&tipo=3');
}
//----------------
function buscar(){
$('#div1').html('<div align="center"><div class="spinner-border" role="status"></div><br><strong>Un momento, por favor...</strong></div>');
$('#div1').load('almacen/5a_tabla.php?fecha1='+cambia(document.form1.OFECHA.value)+'&tipo='+document.form1.optradio.value+'&fecha2='+document.form1.OFECHA2.value);
}
//-----------------------
function agregar(id)
	{
	$('#modal_lg').html('<div align="center"><div class="spinner-border" role="status"></div><br><strong>Un momento, por favor...</strong></div>');
	$('#modal_lg').load('almacen/5b_modal.php?id='+id);
	}
//---------------------
