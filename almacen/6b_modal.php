...
<h4 align="center" style="background-color:#0275d8; color:#FFFFFF" class="modal-title w-100 font-weight-bold py-2">Despachar Solicitud N° <?php echo rellena_cero($numero,3); ?>
