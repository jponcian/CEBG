...
<tr>
<td bgcolor="#99FFCC" align="center" colspan="6" height="6"><strong>Materiales por Solicitar</strong></td>
</tr>
<tr>
...
$consultx = "SELECT * FROM bn_solicitudes_detalle, bn_materiales WHERE bn_materiales.id_bien = bn_solicitudes_detalle.id_bien AND division=$origen AND estatus=0;"; 
//echo $consultx;
