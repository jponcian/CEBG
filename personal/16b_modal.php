...
<form id="form999" name="form999" method="post">
    ...
    <div class="modal-header bg-fondo text-center">
        <h4 align="center" style="background-color:#0275d8; color:#FFFFFF" class="modal-title w-100 font-weight-bold py-2">Agregar Sueldo<button type="button" class="close" data-dismiss="modal">&times;</button></h4>
