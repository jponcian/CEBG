...
class PDF extends FPDF
{
	...
	$this->Image('../../images/logo_nuevo.jpg',40,10,35);
	...
	$this->Cell(0,5,'Dirección de Talento Humano',0,0,'C'); $this->Ln(5);
	$this->Cell(0,5,'Rif G-20001287-0',0,0,'C'); 
	$this->Ln(8);
	
	$this->SetFont('Times','B',11);
	$this->Cell(0,5,'RELACIÓN DE EMPLEADOS EN NOMINA',0,0,'C'); 
	$this->Ln(7);
	...
	$this->Cell($d=20,7,'Fecha Ing',1,0,'C',1);
		if ($_SESSION['filtro']==3)
			{$this->Cell($d1=20,7,'Fecha Egre.',1,0,'C',1);}
		else	
			{$this->Cell($d1=20,7,'Profesion',1,0,'C',1);}
	$this->Cell($d2=12,7,'Hijos',1,0,'C',1);
	$this->Cell($d,7,'Suspendido',1,0,'C',1);
	$this->Cell($e=0,7,'Telefono',1,1,'C',1);
	}
...
$pdf->SetTitle('Empleados en Nomina');
...
//		$pdf->Cell(0,5.5,'				'.$registro->nomina,1,1,'L',1);	
	...
	if ($ubicacion<>$registro->ubicacion)
		...
		$pdf->Cell(0,5.5,'				'.$registro->ubicacion,1,1,'L',1);	
