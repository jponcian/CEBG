...
<form id="form999" name="form999" method="post">
    ...
    <div class="modal-header bg-fondo text-center">
        <h4 align="center" style="background-color:#0275d8; color:#FFFFFF" class="modal-title w-100 font-weight-bold py-2">Agregar CestaTickets<button type="button" class="close" data-dismiss="modal">&times;</button></h4>
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                <div class="input-group">
					<div class="input-group-text"><i class="fas fa-money-bill-alt mr-2"></i></div>
					<input value="0" id="txt_monto" placeholder="Sueldo Minimo" onFocus="this.select()" name="txt_monto" class="form-control" type="text" style="text-align:right" />
					</div>
            </div>
