...
<tbody><?php 
$consultx = "SELECT eval_odis.*, a_areas.area FROM	a_areas, eval_odis WHERE eval_odis.id_area = a_areas.id AND eval_odis.id_area=$id_area AND eval_odis.id_proyecto='".$proyecto_actual[0]."' ORDER BY	a_areas.id ASC";//$filtrar.$_GET['valor'].";"; 
$tablx = $_SESSION['conexionsql']->query($consultx);
if ($tablx->num_rows>0)
	{		}
else
	{	?><tr><td colspan="4"><div align="center" ><h4>No Existen ODIS Cargados</h4></div></td></tr><?php }
//-------------
while ($registro = $tablx->fetch_object())
	{ 	
		...
		$id_area = $registro->id_area;
		//---------
		$consultx1 = "SELECT * FROM eval_asignacion WHERE id_odi=$id_odi AND id_evaluacion='".$proyecto_actual[0]."' AND cedula='$cedula' LIMIT 1"; 
