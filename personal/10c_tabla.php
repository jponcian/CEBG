...
<tr>
<td class="TituloTablaP" height="41" colspan="10" align="center">Permisos y/o Reposos Registrados</td>
</tr>
<tr>
...
$consultx = "SELECT * FROM rrhh_permisos WHERE cedula = $cedula AND (tipo='REPOSO' or tipo='PERMISO') ORDER BY fecha;";//.$_GET['valor'].";"; 
//echo $consultx;
