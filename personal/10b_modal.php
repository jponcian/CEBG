...
<div class="modal-header bg-fondo text-center">
	<h4 align="center" style="background-color:#0275d8; color:#FFFFFF" class="modal-title w-100 font-weight-bold py-2">SOLICITUD DE PERMISOS Y/O REPOSOS
		...
		<div class="form-group col-sm-12 ml-5">
			<div class="btn-group btn-group-toggle" data-toggle="buttons">
				<label class="btn btn-primary active">
					<input checked type="radio" name="txt_opcion" id="txt_opcion" value="PERMISO" autocomplete="off"> PERMISO
				</label>
