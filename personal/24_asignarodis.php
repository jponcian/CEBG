...
$consulta_x = "SELECT estatus FROM evaluaciones WHERE estatus IN (2)";
...
//					  title: '',
			  icon: 'error',				
			  title: 'El Proceso de Asignación de Odi no está abierto!',				
			  timer: 2000,				
...
<div align="center" class="TituloP">ASIGNAR ODIS</div><br>
...
<!-- <input name="obuscar" id="obuscar" type="text" size="100" class="form-control" onKeyPress="buscar2(event,this);" />-->
 ...
 <br>
	<div class="alert alert-warning alert-dismissible fade show" role="alert" align="center">
	  <strong><?php echo $proyecto_actual[2]; ?></strong>
...
function busca_empleados()
	...
	if(document.form1.optradio.value==0 || document.form1.optradio.value==1){
		...
		$('#div2').load('personal/24a_tabla.php?tipo='+document.form1.optradio.value+'&dir='+document.form1.txt_direccion.value+'&area='+document.form1.txt_area.value);
			}
	}
//---------------------------
