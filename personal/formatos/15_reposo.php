...
////////// DATOS
$consulta = "SELECT rrhh_permisos.tipo as tip, rrhh_permisos.*, rac.*, CONCAT(rac.nombre,' ',rac.nombre2,' ',rac.apellido,' ',rac.apellido2) as  nombre FROM rrhh_permisos, rac WHERE rrhh_permisos.cedula = rac.cedula AND id = ".$_SESSION['id_ct'].";"; 
...
$pdf->Cell(0,5,'SOLICITUD DE PERMISO',0,1,'C'); 
$pdf->SetFont('Times','B',14);
$pdf->Cell(0,5,'(REPOSO)',0,0,'C'); 
$pdf->Ln(15);
...
$pdf->SetFont('Times','B',10);
$pdf->Cell(110,21,"LAPSO DE DURACIÓN DEL REPOSO",1,0,'C',1);
