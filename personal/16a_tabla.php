...
<table class="formateada table" border="1" align="center" width="70%">
    <tr>
        <td class="TituloTablaP" height="41" colspan="10" align="center">Sueldos Registrados</td>
    </tr>
    <tr>
        <td bgcolor="#CCCCCC" align="center"><strong>Item</strong></td>
        <td bgcolor="#CCCCCC" align="center"><strong>Sueldo</strong></td>
...
$consultx = "SELECT * FROM a_sueldo_minimo WHERE 1=1 ;";//$filtrar.$_GET['valor'].";"; 
//echo $consultx;
