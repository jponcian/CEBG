...
<tr>
<td class="TituloTablaP" height="41" colspan="10" align="center">Vacaciones Registradas</td>
</tr>
<tr>
...
$consultx = "SELECT * FROM rrhh_permisos WHERE cedula = $cedula AND tipo='VACACIONES' ORDER BY fecha;";//.$_GET['valor'].";"; 
//echo $consultx;
...
<td ><div align="center" ><?php echo voltea_fecha($registro->incorporacion); ?></div></td>
<td valign="middle" align="center"><div><a href="" class="btn btn-outline-success btn-rounded btn-sm font-weight-bold" onclick="vacaciones('<?php echo encriptar($registro->id); ?>');" data-toggle="modal" data-target="#modal_largo" data-keyboard="false"><i class="fa-regular fa-file-pdf fa-2x"></i></a></div></td>
