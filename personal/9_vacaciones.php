...
<div align="center" class="TituloP">VACACIONES</div><br>
...
-->
			...
			<div class="form-check ml-3">
                <label class="form-check-label">
                   ...
                   Personal con Vacaciones Generadas
                </label>
            </div>			
        </diw>
...
function historial(id)
	...
	$('#modal_lg').load('personal/9c_tabla.php?id='+id);
	}
//--------------------------------------------
function agregar()
	{
	$('#modal_lg').html('<div align="center"><div class="spinner-border" role="status"></div><br><strong>Un momento, por favor...</strong></div>');
	$('#modal_lg').load('personal/9b_modal.php');
	}
//---------------------
function buscar2(e)
 	 {
...
function busca_empleados()
	...
	if(document.form1.optradio.value==1 || document.form1.optradio.value==4 || document.form1.optradio.value==6){
		...
		$('#div2').load('personal/9a_tabla.php?tipo='+document.form1.optradio.value+'&valor='+document.form1.obuscar.value);
			}
	}
</script>