...
function eliminar(id) {
    alertify.confirm("Estas seguro de eliminar el Monto Registrado?",
        function() {
            var parametros = "id=" + id;
            $.ajax({
                url: "personal/17c_eliminar.php",
                type: "POST",
                data: parametros,
                success: function(r) {
