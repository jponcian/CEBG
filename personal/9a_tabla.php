...
switch ($filtro) {
    case 1:
        ...
        break;		
    case 4:
        $consultx = "SELECT rac.* FROM rrhh_permisos, rac WHERE rrhh_permisos.cedula = rac.cedula AND rrhh_permisos.tipo = 'VACACIONES' ORDER BY rrhh_permisos.fecha DESC";
        break;		
    case 6:
...
if ($filtro<>4) {$consultx = "SELECT * FROM rac WHERE 1=1 $filtrar ORDER BY vacaciones, nomina, ubicacion, cedula;";}
//echo $consultx;
