...
<tr>
<td class="TituloTablaP" height="41" colspan="10" align="center">Partidas Registradas</td>
</tr>
<tr>
...
$consultx = "SELECT * FROM a_presupuesto_$anno WHERE categoria = '$id' ORDER BY codigo ";//$filtrar.$_GET['valor'].";"; 
//echo $consultx;
...
<td ><div align="left" ><strong><?php echo formato_partida2($registro->codigo); ?></strong></div></td>
...
<td ><div align="center" ><a data-toggle="tooltip" title="Eliminar"><button type="button" class="btn btn-outline-danger btn-sm" onclick="eliminar2('<?php echo ($registro->codigo); ?>', '<?php echo $id; ?>', '<?php echo $anno; ?>');"><i class="fas fa-trash-alt"></i></button></a></div></tr>
 <?php 
 }
 ?>
  <tr>
