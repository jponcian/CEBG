...
<form id="form1" name="form1" method="post" onsubmit="return evitar();" >
 <div align="center" class="TituloP">Traslados entre Partidas</div>
		<br >
<div  class="text-right mb-3"><a href="" class="btn btn-outline-primary btn-rounded btn-sm font-weight-bold" onclick="agregar();" data-toggle="modal" data-backdrop="static" data-target="#modal_largo" data-keyboard="false"><i class="fas fa-plus-circle" ></i> Agregar Traslado</a></div>
		<diw class="row ml-3">
...
$('#OFECHA2').datepicker();
//------------------
function aprobar_traslado(id)
	{
	Swal.fire({
		title: 'Estas seguro de Aprobar el Traspaso?',
//		text: "Esta acción no se puede revertir!",
		...
		if (result.isConfirmed) {
			...
			$.ajax({  
				type : 'POST',
				url  : 'presupuesto/4j_guardar.php?',
				dataType:"json",
				data:  parametros, 
...
function agregar()
	...
	$('#modal_lg').load('presupuesto/4b_modal.php');
	}
//---------------------------
function ver()
 	{
...
//---------------------------
function imprimir_t(id)
 	{
	window.open("presupuesto/formatos/5_traspaso.php?id="+id,"_blank");
	}
//---------------------------
function rep()
 	{
	if (document.form1.optradio.value>0)
		...
		if (((document.form1.optradio.value==1 || document.form1.optradio.value==2 || document.form1.optradio.value==5) && document.form1.obuscar.value!='') || (document.form1.optradio.value==3 && document.form1.OFECHA.value!='' && document.form1.OFECHA2.value!='') || (document.form1.optradio.value==4))
			{
			window.open("presupuesto/reporte/2_rep_traslados.php","_blank");
			}
		//----------------
		}
	}
...
if (((document.form1.optradio.value==1 || document.form1.optradio.value==2 || document.form1.optradio.value==5) && document.form1.obuscar.value!='') || (document.form1.optradio.value==3 && document.form1.OFECHA.value!='' && document.form1.OFECHA2.value!='') || (document.form1.optradio.value==4))
	...
	$('#div1').load('presupuesto/4a_tabla.php?valor='+cambia(document.form1.obuscar.value)+'&tipo='+document.form1.optradio.value+'&fecha1='+document.form1.OFECHA.value+'&fecha2='+document.form1.OFECHA2.value);
	}
}
</script>