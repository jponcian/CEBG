...
<?php if ($registro->total>0 and $registro->estatus==80) { ?><td ><div align="center" ><button onclick="solicitar('<?php echo encriptar($registro->id); ?>','<?php echo ($registro->oficina); ?>');" type="button" class="btn btn-outline-success waves-effect"><i class="fas fa-cloud-upload-alt prefix grey-text mr-1"></i> Generar Solicitud</button></div> </td><?php 
 }
 ?>
<?php if ($registro->total>0 and $registro->estatus==5) { ?><td ><div align="center" ><button onclick="aprobar('<?php echo encriptar($registro->id); ?>','<?php echo encriptar($registro->cedula); ?>');" type="button" class="btn btn-outline-success waves-effect"><i class="fa-regular fa-circle-check prefix grey-text mr-1"></i> Aprobar Solicitud</button></div> </td><?php 
 }
 ?>
</tr>
 <?php 
