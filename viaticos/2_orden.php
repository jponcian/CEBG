...
function aprobar(id, cedula)
	...
	function()
		{
		var parametros = "id=" + id + "&cedula=" + cedula; 
		$.ajax({  
			type : 'POST',
...
function buscar(){
	...
	$('#div1').load('viaticos/2a_tabla.php?valor='+cambia(document.form1.obuscar.value)+'&tipo='+document.form1.optradio.value+'&fecha1='+document.form1.OFECHA.value+'&fecha2='+document.form1.OFECHA2.value);
}
//---------------------
