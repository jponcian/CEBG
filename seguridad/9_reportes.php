...
<div align="center" class="TituloP">Relacion de Asistencia</div>
<br >
<table border="1"><tr align="center">
	...
	<diw class="row ml-3">
			...
			<div class="form-check ml-3">
                <label class="form-check-label">
                    <input type="radio" class="form-check-input" name="optradio" value="<?php echo encriptar('0'); ?>" checked >
                   Ver Todos
                </label>
            </div>			
        </diw>
	...
	<div class="row">
			<div class="form-group col-sm-6 ml-5">
				<div class="input-group-text">Direccion: <select class="custom-select" style="font-size: 14px" name="txt_direccion" id="txt_direccion" onChange="ver_empleados(this.value);">
...
<button type="button" id="botonb" class="btn btn-primary" onClick="reportes2();"><i class="fas fa-search mr-2"></i>Ver Reporte</button></td><td>
<button type="button" id="botonb" class="btn btn-success" onClick="reportes3();"><i class="fas fa-search mr-2"></i>Full Ent/Sal</button></td></tr></table></div>
</tr></table>
</form>
...
function reportes3()
 	{
	window.open("seguridad/reporte/asistencia_detalle_todo.php?desde="+document.form1.OFECHA.value+"&hasta=" +document.form1.OFECHA2.value+"&tipo=" +document.form1.optradio.value+"&direccion=" +document.form1.txt_direccion.value+"&cedula=" +document.form1.txt_empleado.value,"_blank");
...
function reportes2()
 	{
	window.open("seguridad/reporte/asistencia_detalle.php?desde="+document.form1.OFECHA.value+"&hasta=" +document.form1.OFECHA2.value+"&tipo=" +document.form1.optradio.value+"&direccion=" +document.form1.txt_direccion.value+"&cedula=" +document.form1.txt_empleado.value,"_blank");
//	window.open("almacen/reporte/2_movimiento2.php?desde="+document.form1.OFECHA.value+"&hasta=" +document.form1.OFECHA2.value+"&tipo=" +document.form1.optradio.value+"&direccion=" +document.form1.txt_direccion.value,"_blank");
	}
</script>