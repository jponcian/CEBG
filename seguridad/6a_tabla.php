...
if ($buscar <>'')	
	{
	$filtro = " AND (asistencia_diaria_visita.cedula like '%$buscar%' OR asistencia_diaria_visita.direccion like '%$buscar%' OR asistencia_diaria_visita.tipo like '%$buscar%' OR rac_visita.nombre like '%$buscar%') ";	//$_SESSION['titulo'] = 'POR VERIFICAR';
	} 
//elseif ($_GET['tipo']=='2')	 
//	{
...
FROM
	...
	rac_visita 
WHERE
	asistencia_diaria_visita.cedula = rac_visita.cedula AND fecha='".date('Y/m/d')."' $filtro ORDER BY estatus, fecha DESC, ingreso DESC;";
//echo $consultx;
