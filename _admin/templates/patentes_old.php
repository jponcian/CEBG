  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header bg-fondo text-white text-center">
        <h4 class="modal-title text-white w-100 font-weight-bold py-2">Datos de la Patente a Incluir</h4>
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-4">
              <div class="input-group">
                ...
                <input type="text" ng-change="buscarNumero(patente.numero)" class="form-control {{formPatente.numero.$touched === true ? numero_existe === false ? 'is-valid' : 'is-invalid' : ''}}" name="numero" id="numero" placeholder="Numero patente" ng-model="patente.numero" minlength="1" maxlength="6" required entero>
              </div>
      ...
      <div class="modal-footer justify-content-center">
        <button type="button" class="btn btn-outline-primary waves-effect" ng-click="agregarPatente(formPatente)"><i class="fas fa-cloud-upload-alt prefix grey-text mr-1"></i> Guardar</button>
      </div>
...
<div class="modal fade bd-example-modal-lg" id="myModalEditPatente">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header bg-fondo text-white text-center">
        <h4 class="modal-title text-white w-100 font-weight-bold py-2">Datos de la Patente a Editar</h4>
       ...
       <form id="formEditPatente" name="formEditPatente" method="post" novalidate>
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-4">
              <div class="input-group">
                <div class="input-group-text"><i class="far fa-credit-card"></i></div>
                <input type="text" ng-change="buscarNumeroEditar(editnumero)" class="form-control {{formEditPatente.editnumero.$touched === true ? numero_existe === false ? 'is-valid' : 'is-invalid' : ''}}" name="editnumero" id="editnumero" placeholder="Numero patente" ng-model="editnumero" minlength="1" maxlength="6" required entero>
              </div>
                <div class="col-md-12" style="font-size: 10px; padding-left: 50px">              
                  <strong class="text-danger stretched-link text-right" ng-show="numero_existe === true" role="alert">
                    Patente ya registrada
      ...
      <!-- Modal footer -->
      <div class="modal-footer justify-content-center">
        <button type="button" class="btn btn-outline-primary waves-effect" ng-click="modificarPatente(formEditPatente)"><i class="fas fa-cloud-upload-alt prefix grey-text mr-1"></i> Guardar Cambios</button>
      </div>
...
<!--  FIN MODAL EDITAR -->
  ...
  <table class="table table-hover table-sm table-responsive-sm">
    ...
    <tbody>
      <tr ng-repeat="x in patentes | filter:busqueda | limitTo: 20">
        ...
        <td align="center"><span class="badge badge-pill badge-primary {{x.estatus == 0 ? 'badge-info' : x.estatus == 1 ? 'badge-warning' : 'badge-danger'}}">{{x.estatus == 0 ? 'Activa' : x.estatus == 1 ? 'Vencida' : 'Anulada'}}</span></td>
        <td align="center">
