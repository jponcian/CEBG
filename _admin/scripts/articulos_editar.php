<?php
    ...
    if(!empty($_FILES))
    {
        ...
        if (in_array($_FILES['file']['type'], $tipos) && $_FILES['file']['size'] <= $limite_kb)
        {
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'], $path))
            {
                ...
                echo $admin_articulo->Editar($id, $titulo, $descripcion, $usuario, $nombre_imagen, $img_anterior);
            }
            else
            {
    ...
    else
    {
        ...
        echo $admin_articulo->Editar($id, $titulo, $descripcion, $usuario, $img_anterior, $img_anterior);
        //echo $id, $titulo.' - '.$descripcion.' - '.$usuario.' - '.$img_anterior;
